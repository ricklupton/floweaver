...
# -*- coding: utf-8 -*-
#
# Sankey-view documentation build configuration file, created by
...
# Extra paths copied verbatim into the build output root
...
htmlhelp_basename = 'Sankey-viewdoc'
...
latex_documents = [
    (master_doc, 'Sankey-view.tex', 'Sankey-view Documentation',
     'Rick Lupton', 'manual'),
]
...
man_pages = [
    (master_doc, 'sankey-view', 'Sankey-view Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Sankey-view', 'Sankey-view Documentation',
     author, 'Sankey-view', 'One line description of project.',
     'Miscellaneous'),
]
