...
def sankey_view(sankey_definition, dataset, measure='value', agg_measures=None):
    ...
    bundle_flows, unused_flows = dataset.apply_view(sankey_definition.nodes,
                                                    bundles2, sankey_definition.flow_selection)
